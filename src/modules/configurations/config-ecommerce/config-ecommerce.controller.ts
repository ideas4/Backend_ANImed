...
import { CreateConfigDoctorDto } from './dto/create-config-doctor';
/**
...
export class ConfigEcommerceController {
  constructor(
    private readonly configEcommerceService: ConfigEcommerceService,
  ) {}
  ...
  // @ApiConflictResponse({
  //   description: 'Ya existe una configuración de tienda creada',
  // })
  ...
  @ApiBearerAuth()
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({ summary: 'Crea la configuración inicial del doctor' })
  @ApiOkResponse({ status: 200, description: 'Información Ok' })
  @ApiConflictResponse({
    description: 'Ya existe una configuración de dcotor',
  })
  create(@Body() createConfigDoctor: CreateConfigDoctorDto) {
    return this.configEcommerceService.create(createConfigDoctor);
  }
  ...
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({
    summary: 'Modifica la información de configuración del doctor',
  })
  @ApiOkResponse({
    status: 200,
    description: 'Información Ok',
  })
  updateInfoDoctor(@Body() body: InfoEcommerceDto) {
  ...
  updateConfigDoctor(@Body() createConfigDoctor: CreateConfigDoctorDto) {
    return this.configEcommerceService.updateInfoDoctor(createConfigDoctor);
  }
  ...
  @ApiOkResponse({
    status: 200,
    description: 'Información Ok',
    type: HomeInfoEcommerceDto,
  })
  @ApiNotFoundResponse({
    description: 'No existe una configuración de tienda creada',
  })
  findAll() {
  ...
  @ApiTags('Public')
  @ApiOperation({
    summary: 'Obtiene el banner de la promoción del mes si existe',
  })
  ...
  @ApiOperation({
    summary:
      'Obtiene el mensaje de correo electronico para confirmación de cuentas',
  })
  @ApiOkResponse({
    status: 200,
    description: 'Información Ok',
  ...
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({
    summary: 'Obtiene el mensaje de correo electronico para ordenes',
  })
  @ApiOkResponse({
    status: 200,
    description: 'Información Ok',
  ...
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({
    summary: 'Modifica la información del footer del e-commerce',
  })
  @ApiOkResponse({
    status: 200,
    description: 'Información Ok',
  ...
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({
    summary: 'Modifica el banner de la promoción del mes si existe',
  })
  @ApiOkResponse({ status: 200, description: 'Información Ok', type: String })
  ...
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({
    summary: 'Modifica mensaje de correo de confirmación de cuenta',
  })
  @ApiOkResponse({ status: 200, description: 'Información Ok', type: String })
  ...
  @ApiOkResponse({ status: 200, description: 'Información Ok' })
  @ApiConflictResponse({
    description: 'Solo deben existir cuatro productos destacados',
  })
