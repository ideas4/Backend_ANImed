...
export class StoresController {
  ...
  @Get('fill')
  @ApiOperation({ summary: 'Permite obtener una lista con nombre y clave de las sucursales' })
  @ApiOkResponse({status: 200,description: 'Sucursal Ok'})
  fill() {
  ...
  @Get('fill/:id')
  @ApiOperation({ summary: 'Permite obtener una lista con nombre y clave de las sucursales en las cuales hay existencia de un producto' })
  @ApiOkResponse({status: 200,description: 'Sucursal Ok'})
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Permite obtener la información de una sucursal para editar' })
  @ApiOkResponse({status: 200,description: 'Sucursal Ok'})
